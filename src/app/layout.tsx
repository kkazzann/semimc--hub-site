...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: 'Oficjalny hub z linkami do social mediów, sklepu i aktualnych wydarzeń.',
    images: ['/og-hub.png'],
  },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="pl">
      <body style={{ margin: 0, background: 'rgb(29, 1, 26)', color: 'white' }} className={poppins.className}>{children}</body>
    </html>
  );
}